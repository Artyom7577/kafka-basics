...
public class KafkaConsumer {
    ...
    public static void strat(String instanceId) {
        ...
        var consumerConfig = Map.<String, Object>of(
            ...
            ConsumerConfig.PARTITION_ASSIGNMENT_STRATEGY_CONFIG, CooperativeStickyAssignor.class.getName(), // use CooperativeStickyAssignor for better rebalancing default is RangeAssignor
